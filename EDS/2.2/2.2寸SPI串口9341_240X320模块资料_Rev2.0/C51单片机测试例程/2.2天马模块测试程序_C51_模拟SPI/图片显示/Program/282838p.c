...
unsigned char code gImage_ww[3200];
...
main()
{
	...
	while(1)
	{
		showimage(gImage_qq);//QQ图片测试
		delay(10000);
		showimage(gImage_ww);//旺旺图片测试
		delay(10000);
	}
}
...
//请尽量使用大容量的51单片机比如STC12C5A60S2，
//否则下面两个数据可能装不下导致编译失败，
//此时请屏蔽掉下面两个数组代码即可编译通过
#define LARGEFLASH
#ifdef  LARGEFLASH
...
unsigned char code gImage_ww[3200] = { /* 0X00,0X10,0X28,0X00,0X28,0X00,0X01,0X1B, */
0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,
0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,
0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,
0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,
...
//单片机存储容量不够，只能定义两个空数组，无法完成图片显示实验
#else
unsigned char code gImage_qq[]={
0,0,
};
unsigned char code gImage_ww[]={
0,0,
};
#endif
