...
void LCD_LCD_WRITE_COM_DATA(int a){//16位数据,分两次，每次送8位
      C_D = 1;
      LCD_Writ_Bus(a>>8);
	  LCD_Writ_Bus(a);
}
...
void Address_set(unsigned int x1,unsigned int x2,unsigned int y1,unsigned int y2)
{
     	...
     	LCD_LCD_WRITE_COM_DATA(x1);
     	LCD_LCD_WRITE_COM_DATA(x2);
	    LCD_WRITE_CMD(0x2b); 	//y轴   
	    LCD_LCD_WRITE_COM_DATA(y1);
     	LCD_LCD_WRITE_COM_DATA(y2);
     	LCD_WRITE_CMD(0x2c);
}
...
void LCD_TEST_SingleColor(int Discolor){
		...
		for (i=0;i<320;i++){
			for (j=0;j<240;j++){
				LCD_LCD_WRITE_COM_DATA(Discolor);
				}
		}
}
...
void Initial_ILI9340C(void)
{
	...
	LCD_WRITE_COM_DATA(0X3C); 

	LCD_WRITE_CMD(0xC7);  
	LCD_WRITE_COM_DATA(0XA9); 

	LCD_WRITE_CMD(0x3A);  
	LCD_WRITE_COM_DATA(0X55); 
	
        LCD_WRITE_CMD(0x36);  
	LCD_WRITE_COM_DATA(0x48);//êú?á2?êy 
	...
	LCD_WRITE_COM_DATA(0X17); 
	LCD_WRITE_COM_DATA(0X14); 
	LCD_WRITE_COM_DATA(0X09); 
	LCD_WRITE_COM_DATA(0X0C); 
	LCD_WRITE_COM_DATA(0X06); 
	LCD_WRITE_COM_DATA(0X43); 
	LCD_WRITE_COM_DATA(0X75); 
	LCD_WRITE_COM_DATA(0X36); 
	LCD_WRITE_COM_DATA(0X08); 
	LCD_WRITE_COM_DATA(0X13); 
	LCD_WRITE_COM_DATA(0X05); 
	LCD_WRITE_COM_DATA(0X10); 
	LCD_WRITE_COM_DATA(0X0B); 
	LCD_WRITE_COM_DATA(0X08); 


	LCD_WRITE_CMD(0xE1);  
	LCD_WRITE_COM_DATA(0X00); 
	LCD_WRITE_COM_DATA(0X1F); 
	LCD_WRITE_COM_DATA(0X23); 
	LCD_WRITE_COM_DATA(0X03); 
	LCD_WRITE_COM_DATA(0X0E); 
	LCD_WRITE_COM_DATA(0X04); 
	LCD_WRITE_COM_DATA(0X39); 
	LCD_WRITE_COM_DATA(0X25); 
	LCD_WRITE_COM_DATA(0X4D); 
	LCD_WRITE_COM_DATA(0X06); 
	LCD_WRITE_COM_DATA(0X0D); 
	LCD_WRITE_COM_DATA(0X0B); 
	LCD_WRITE_COM_DATA(0X33); 
